...
<template>
  <header class="flex">
    ...
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuLink href="/posts" :class="navigationMenuTriggerStyle()">
            Articles
          </NavigationMenuLink>
        </NavigationMenuItem>
        <NavigationMenuItem>
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        ...
        <DropdownMenuItem
          ><iconify-icon icon="ooui:articles-ltr" class="size-4" />My Posts</DropdownMenuItem
        >
        <DropdownMenuSeparator />
        <DropdownMenuItem
          ><iconify-icon icon="octicon:sign-out-24" class="size-4" />Sign Out</DropdownMenuItem
        >
      </DropdownMenuContent>
    </DropdownMenu>
  </header>
